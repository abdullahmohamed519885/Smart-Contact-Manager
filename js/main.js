...
let btnCloseSectionNewContactMissingName = document.getElementById("sectionNewContactMissing")
let btnCloseSectionNewContactMissingPhone = document.getElementById("sectionNewContactMissing")
let btnWarningSectionDeleteContact = document.getElementById("warningSectionDeleteContact")
let btnSuccessSectionAddContact = document.getElementById("successSectionAddContact")
let btnSuccessSectionUpdateContact = document.getElementById("successSectionUpdateContact")
let btnSuccessSectionDeleteContact = document.getElementById("successSectionDeleteContact")
...
function missingName(){
    return `
                <section class="vh-100 modal-body z-3000">
                <div class="add-contact h-100 add-contact-card-bg position-fixed inset-0 ">
                    <div class="container h-100 px-0">
                        <div class="inner h-100 d-flex-center position-fixed inset-0 overflow-hidden p-16">
                            <div class="card max-width-512 max-height-380 overflow-scroll scrollbar-width rounded-px-4 bg-white w-100 h-100">
                                <div class="contact-info p-16">
                                    <div class="mb-20 photo d-flex-center flex-column mt-30">
                                        <div class="image-person width-px-96 height-px-96 d-flex-center missing-faild-color fs-30 rounded-circle mb-40 missing-faild-border">
                                            <i class="fa-solid fa-xmark fs-45"></i>
                                        </div>
                                        <div class="text text-center  missing-faild-h3-color">
                                            <h3 class="fs-30 fw-bold mb-20">Missing Name</h3>
                                            <p class="fs-18">Please enter a name for the contact!</p>
                                        </div>
                                    </div>
                                    <div class="mb-10 button d-flex-around">
                                        <button onclick="closesectionNewContactMissingName()" class="border-0 fs-16 px-20 py-12 rounded-px-4 missing-faild-button-bg missing-faild-button-bg-hover text-white">Ok</button>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card max-width-512 max-height-380 overflow-scroll scrollbar-width rounded-px-4 bg-white w-100 h-100">
                                <div class="contact-info p-16">
                                    <div class="mb-20 photo d-flex-center flex-column mt-30">
                                        ...
                                        <div class="text text-center  missing-faild-h3-color">
                                            <h3 class="fs-30 fw-bold mb-20">Missing Phone</h3>
                                            <p class="fs-18">Please enter a phone number!</p>
                                        </div>
                                    </div>
                                    <div class="mb-10 button d-flex-around">
                                        <button onclick="closesectionNewContactMissingPhone()" class="border-0 fs-16 px-20 py-12 rounded-px-4 missing-faild-button-bg missing-faild-button-bg-hover text-white">Ok</button>
                                    </div>
                                </div>
                            </div>
                        </div>
...
function warningDeleteContact(){
    return `
            <section class="vh-100 modal-body z-3000">
                <div class="add-contact h-100 add-contact-card-bg position-fixed inset-0 ">
                    <div class="container h-100 px-0">
                        <div class="inner h-100 d-flex-center position-fixed inset-0 overflow-hidden p-16">
                            <div class="card max-width-512 max-height-380 overflow-scroll scrollbar-width rounded-px-4 bg-white w-100 h-100 px-9">
                                <div class="contact-info p-16">
                                    <div class="mb-15 photo d-flex-center flex-column mt-20">
                                        <div class="image-person width-px-96 height-px-96 d-flex-center warning-delete-color fs-30 rounded-circle mb-40 warning-delete-border">
                                            <i class="fa-solid fa-exclamation"></i>
                                        </div>
                                        <div class="text text-center  missing-faild-h3-color">
                                            <h3 class="fs-30 fw-bold mb-20">Delete Contact?</h3>
                                            <p class="fs-18">Are you sure you want to delete Flynn Gilbert? This action cannot be undone.</p>
                                        </div>
                                    </div>
                                    <div class="button d-flex-center">
                                        <button onclick="deleteContact()" class="border-0 fs-16 px-20 py-12 rounded-px-4 warning-delete-button-yes-delete-bg warning-delete-button-yes-delete-bg-hover text-white mr-10">Yes, delete it!</button>
                                        <button onclick="closeWarningSectionDeleteContact()" class="border-0 fs-16 px-20 py-12 rounded-px-4 warning-delete-button-cancel-bg warning-delete-button-cancel-bg-hover text-white">Cancel</button>
                                    </div>
                                </div>
                            </div>
                        </div>
...
function successAddCountact(){
    return `
            <section class="vh-100 modal-body z-3000">
                <div class="add-contact h-100 add-contact-card-bg position-fixed inset-0 ">
                    <div class="container h-100 px-0">
                        <div class="inner h-100 d-flex-center position-fixed inset-0 overflow-hidden p-16">
                            <div class="card max-width-512 max-height-300 overflow-scroll scrollbar-width rounded-px-4 bg-white w-100 h-100 px-9">
                                <div class="contact-info p-16">
                                    <div class="mb-15 photo d-flex-center flex-column mt-20">
                                        <div class="image-person width-px-96 height-px-96 d-flex-center success-update-color fs-30 rounded-circle mb-40 success-update-border">
                                            <i class="fa-solid fa-check"></i>
                                        </div>
                                        <div class="text text-center  missing-faild-h3-color">
                                            <h3 class="fs-30 fw-bold mb-20">Added!</h3>
                                            <p class="fs-18">Contact has been added successfully.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
function successUpdatedCountact(){
    return `
            <section class="vh-100 modal-body z-3000">
                <div class="add-contact h-100 add-contact-card-bg position-fixed inset-0 ">
                    <div class="container h-100 px-0">
                            ...
                            <div class="card max-width-512 max-height-300 overflow-scroll scrollbar-width rounded-px-4 bg-white w-100 h-100 px-9">
                                <div class="contact-info p-16">
                                    <div class="mb-15 photo d-flex-center flex-column mt-20">
                                        ...
                                        <div class="text text-center  missing-faild-h3-color">
                                            <h3 class="fs-30 fw-bold mb-20">Updated!</h3>
                                            <p class="fs-18">Contact has been updated successfully.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
function successDeleteCountact(){
    return `
            <section class="vh-100 modal-body z-3000">
                <div class="add-contact h-100 add-contact-card-bg position-fixed inset-0 ">
                    <div class="container h-100 px-0">
                            ...
                            <div class="card max-width-512 max-height-300 overflow-scroll scrollbar-width rounded-px-4 bg-white w-100 h-100 px-9">
                                <div class="contact-info p-16">
                                    <div class="mb-15 photo d-flex-center flex-column mt-20">
                                        ...
                                        <div class="text text-center  missing-faild-h3-color">
                                            <h3 class="fs-30 fw-bold mb-20">Deleted!</h3>
                                            <p class="fs-18">Contact has been deleted.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                                    ...
                                                    <div class="bottom-card header-conact-bottom-card-bg header-conact-bottom-card-border-top pt-10">
                                                        <div class="icons d-flex-between">
                                                            ...
                                                            <div class="left-icon d-flex-around">
                                                                ...
                                                                <button onclick="clickDeleteButton(${i})" class="icon width-px-36 border-0 height-px-36 fs-12 mr-6 rounded-px-8 d-flex-center header-conact-bottom-card-icon4-color header-conact-bottom-card-icon4-bg header-conact-bottom-card-icon5-bg-hover header-conact-bottom-card-icon5-color-hover">
...
function saveContact(i){
    initContactInputs()
    if (!validateName()) {
        btnCloseSectionNewContactMissingName.classList.remove("d-none")
        document.getElementById("sectionNewContactMissing").innerHTML = missingName()
        return;
    }else if (!validatePhone()) {
        btnCloseSectionNewContactMissingPhone.classList.remove("d-none")
        document.getElementById("sectionNewContactMissing").innerHTML = missingPhone()
        return;
    }
    contactObject()
    ...
    document.getElementById("successSectionAddContact").innerHTML = successAddCountact
    hiddenSuccessAddPopupAfter5s()
    btnSuccessSectionAddContact.classList.remove("d-none")
    displayContact()
}
...
function closesectionNewContactMissingName(){
btnCloseSectionNewContactMissingName.classList.add("d-none")
}
function closesectionNewContactMissingPhone(){
btnCloseSectionNewContactMissingPhone.classList.add("d-none")
}
function closeWarningSectionDeleteContact(){
btnWarningSectionDeleteContact.classList.add("d-none")
}
...
function clickDeleteButton(){
    btnWarningSectionDeleteContact.classList.remove("d-none")
    btnWarningSectionDeleteContact.innerHTML = warningDeleteContact()
}
function hiddenSuccessAddPopupAfter5s (){
    setTimeout(function (){
        btnSuccessSectionAddContact.classList.add("d-none")
    }, 800)
}
function hiddenSuccessUpdatePopupAfter5s (){
    setTimeout(function (){
        btnSuccessSectionUpdateContact.classList.add("d-none")
    }, 800)
}
function hiddenSuccessDeletePopupAfter5s (){
    setTimeout(function (){
        btnSuccessSectionDeleteContact.classList.add("d-none")
    }, 800)
}
function deleteContact(i){
    contactList.splice(i , 1)
    localStorageSave()
    closeWarningSectionDeleteContact()
    document.getElementById("successSectionDeleteContact").innerHTML = successDeleteCountact()
    hiddenSuccessDeletePopupAfter5s()
    btnSuccessSectionDeleteContact.classList.remove("d-none")
    displayContact()
}
...
function editContact(){
    ...
    clearForm()
    closeContactAddBotton()
    btnSuccessSectionUpdateContact.innerHTML = successUpdatedCountact()
    hiddenSuccessUpdatePopupAfter5s()
    btnSuccessSectionUpdateContact.classList.remove("d-none")
    displayContact()
}
